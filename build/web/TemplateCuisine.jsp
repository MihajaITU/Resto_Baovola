...
<%
    ...
    if (request.getParameter("p") != null) {
        pagesCuisine = "/" + request.getParameter("p") + ".jsp";
    } else {
        pagesCuisine = "/LoginCuisine";
    }
    int idCuisine= (Integer)session.getAttribute("idCuisine");
...
<html class="no-js " lang="fr
    ...
    <body class="theme-black">
            ...
            <div class="container">
                <ul class="nav navbar-nav">
                    ...
                    <li class="float-right">
                        ...
                        <a href="/Resto/LogOutCuisine" class="mega-menu"><i class="zmdi zmdi-power"></i></a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="menu-container">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <ul class="h-menu">
                            <li class="open active"><a href="/Resto/PlatPrepare"><i class="zmdi zmdi-home"></i></a></li>
                            
                            
                            <li><a href="/Resto/PlatPrepare">Liste des plats à livrer</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <section class="content home">
            <div class="container">
                <jsp:include page="<%=pagesCuisine%>"></jsp:include>
            </div>
        </section>
        <!-- Jquery Core Js -->
