        ...
        <div class="container">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 text-center">
                    <div class="card tasks_report">
                        <div class="body">
                            <input type="text" class="knob dial2" value="26" data-width="90" data-height="90"
                        ...
                        <div class="body m-b-10 bg-dark">
                            <div class="row">
                                ...
                                <div class="col-6 text-right">
                                    <div class="sparkline m-t-10" data-type="bar" data-width="97%" data-height="50px"
                                        data-bar-Width="2" data-bar-Spacing="7" data-bar-Color="#18ce0f ">
                                        2,5,6,3,4,5,5,6,2,1</div>
                                </div>
                            </div>
                        </div>
                        <div class="body">
                            <div class="table-responsive earning-report">
                                <table class="table m-b-0 table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="width:60px;"><span class="rounded"><img
                                                        src="assets/images/xs/avatar1.jpg" alt="user" width="50"></span>
                                            </td>
                                            <td>
                                                <h6>John Smith</h6><small class="text-muted">UI UX Designer</small>
                                            </td>
                                            <td><span class="badge badge-success">Low</span></td>
                                            <td>$1.9K</td>
                                        </tr>
                                        <tr class="active">
                                            <td><span class="rounded"><img src="assets/images/xs/avatar2.jpg" alt="user"
                                                        width="50"></span></td>
                                            <td>
                                                <h6>Hossein Shams</h6><small class="text-muted">Project Manager</small>
                                            </td>
                                        ...
                                        <tr>
                                            <td><span class="round round-success"><img
                                                        src="assets/images/xs/avatar3.jpg" alt="user" width="50"></span>
                                            </td>
                                            <td>
                                                <h6>Maryam Amiri</h6><small class="text-muted">Angular Developer</small>
                                            </td>
                                        ...
                                        <tr>
                                            <td><span class="round round-primary"><img
                                                        src="assets/images/xs/avatar4.jpg" alt="user" width="50"></span>
                                            </td>
                                            <td>
                                                <h6>Tim Hank</h6><small class="text-muted">Frontend</small>
                                            </td>
                                        ...
                                        <tr>
                                            <td><span class="round round-warning"><img
                                                        src="assets/images/xs/avatar5.jpg" alt="user" width="50"></span>
                                            </td>
                                            <td>
                                                <h6>Fidel Tonn</h6><small class="text-muted">Content Writer</small>
                                            </td>
                                            <td><span class="badge badge-warning">High</span></td>
                                            <td>$2.5K</td>
                                        </tr>
                                        <tr>
                                            <td><span class="round round-danger"><img src="assets/images/xs/avatar6.jpg"
                                                        alt="user" width="50"></span></td>
                                            <td>
                                                <h6>Frank Camly</h6><small class="text-muted">Graphic Design</small>
                                            </td>
