...
<%
    ...
    if (request.getParameter("p") != null) {
        pagesServeur = "/" + request.getParameter("p") + ".jsp";
    } else {
        pagesServeur = "/LoginLivreur";
    }
    int idServeur= (Integer)session.getAttribute("idServeur");
...
<html class="no-js " lang="en">
    ...
    <body class="theme-black">
            ...
            <div class="container">
                <ul class="nav navbar-nav">
                    ...
                    <li class="float-right">
                        ...
                        <a href="/Resto/LogOutServeur" class="mega-menu"><i class="zmdi zmdi-power"></i></a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="menu-container">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <ul class="h-menu">
                            <li class="open active"><a href="/Resto/GestionCommande?id=<% out.print(idServeur); %>"><i class="zmdi zmdi-home"></i></a></li> 
                            <li><a href="/Resto/PlatDispo?id=<% out.print(idServeur); %>">Liste des plats disponibles</a></li>
                            <li><a href="/Resto/PlatNonLivree?id=<% out.print(idServeur); %>">Liste des plats non livrés</a></li>
                            <li><a href="/Resto/PlatCuit?id=<% out.print(idServeur); %>">Liste des plats cuit</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <section class="content home">
            <div class="container">
                <jsp:include page="<%=pagesServeur%>"></jsp:include>
            </div>
        </section>
        <!-- Jquery Core Js -->
