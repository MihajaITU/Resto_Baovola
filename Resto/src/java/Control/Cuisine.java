...
import Service.ServiceViewPlatNonLivree;
...
public class Cuisine extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ServiceViewPlatNonLivree sp=new ServiceViewPlatNonLivree();
                ViewPlatNonLivree[] liste=sp.findAllPlat();
                request.setAttribute("livree",liste);
