 ...
 * @author HASINA
 */
public class PlatALivraison extends HttpServlet {
            ...
            {   
               ...
               int livreur=Integer.parseInt(request.getParameter("id"));
                ...
                //request.getRequestDispatcher("/TemplateLivreur.jsp?p=platsALivre").forward(request, response);
                 RequestDispatcher dispat = request.getRequestDispatcher("/TemplateLivreur.jsp?p=platsALivre");
                dispat.forward(request, response);
            }catch (Exception ex) {
            Logger.getLogger(PlatALivraison.class.getName()).log(Level.SEVERE, null, ex);
