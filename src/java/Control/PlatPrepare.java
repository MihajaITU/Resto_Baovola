 ...
 * @author HASINA
 */
public class PlatPrepare extends HttpServlet {
            ...
            {   
               ...
               //int cuise=Integer.parseInt(request.getParameter("id"));
                ...
                //request.getRequestDispatcher("/TemplateLivreur.jsp?p=platsALivre").forward(request, response);
                 RequestDispatcher dispat = request.getRequestDispatcher("/TemplateCuisine.jsp?p=platsAPrepare");
                dispat.forward(request, response);
            }catch (Exception ex) {
            Logger.getLogger(PlatPrepare.class.getName()).log(Level.SEVERE, null, ex);
