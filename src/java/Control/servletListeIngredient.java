 ...
 * @author HASINA
 */
public class servletListeIngredient extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet servletListeIngredient</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet servletListeIngredient at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
