...
insert into livreur values (nextval('livreur_sq'),'Koto','koto@gmail.com','koto1234');
insert into livreur values (nextval('livreur_sq'),'Lita','lita@gmail.com','lita1234');
insert into livreur values (nextval('livreur_sq'),'Bema','bema@gmail.com','bema1234');
...
insert into livraison values (nextval('livraison_sq'),'Mahamasina',now());
insert into livraison values (nextval('livraison_sq'),'Antanimena',now());
...
insert into detailsLivraison values (nextval('detailsLivraison_sq'),1,1,20000,true,1);
insert into detailsLivraison values (nextval('detailsLivraison_sq'),1,2,35000,true,1);
insert into detailsLivraison values (nextval('detailsLivraison_sq'),1,5,15000,false,1);

insert into detailsLivraison values (nextval('detailsLivraison_sq'),2,2,35000,false,2);
insert into detailsLivraison values (nextval('detailsLivraison_sq'),2,3,22000,false,2);

-- coté livreur
create view listeLivraison as
select l.id,l.lieu,l.daty,liv.nom,p.designation,d.prixvente,d.etatLivre,d.id_Livreur
from livraison l 
join detailsLivraison d on l.id=d.id_Livraison 
join livreur liv on d.id_Livreur=liv.id 
join produit p on d.id_Produit=p.id;

select * from listeLivraison where id_Livreur=1;

-- coté livreur, plats à livrer
select * from listeLivraison where id_Livreur=1 and etatLivre=false;

select * from listeLivraison where id_Livreur=1 and etatLivre=true;

create sequence livreur_sq start with 1 increment by 1 ;
create sequence livraison_sq start with 1 increment by 1 ;
create sequence detailsLivraison_sq start with 1 increment by 1 ;
